...
namespace CoreLibrary.Redis.Interfaces.RedLock
{
    internal interface IDistributedLockFactory
    {
        ...
        /// <param name="retryDelayMs">���Եļ�� ʱ��</param>
        /// <returns>A RedLock object.</returns>
        Task<IRedLock> CreateLockAsync(string resource, TimeSpan expiryTime, TimeSpan waitTime, TimeSpan retryTime, int? retryCount, int? retryDelayMs, CancellationToken? cancellationToken = null);
    }
}